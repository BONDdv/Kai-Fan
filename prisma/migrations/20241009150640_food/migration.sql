...
-- AddForeignKey
ALTER TABLE `MenuOnOrder` ADD CONSTRAINT `MenuOnOrder_menuId_fkey` FOREIGN KEY (`menuId`) REFERENCES `Menu`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `MenuOnOrder` ADD CONSTRAINT `MenuOnOrder_orderId_fkey` FOREIGN KEY (`orderId`) REFERENCES `Order`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
